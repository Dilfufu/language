...
int main()
{
    // skaskawl - 2023.06.18 : My String Class
    ...
    MyString str3("very long string");
    ...
    std::cout << "Location of first <very> in the string : " << str5.find(0, "very") << std::endl;
    std::cout << "Location of second <very> in the string : " << str5.find(str5.find(0, "very") + 1, "very") << std::endl;
...
MyString& MyString::erase(int loc, int num) 
{
    ...
    if (num < 0 || loc < 0 || loc > string_length || (string_length - loc) < num) 
        return *this;
